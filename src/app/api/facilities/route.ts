...
type TimeSlotUCLA = {
  ...
  className: string; // "s-lc-eq-available" or "s-lc-eq-checkout"
};

type ReservationResponseUCLA = {
  slots: TimeSlotUCLA[];
};
...
const libraries: Libraries = {
  "Powell Library": {
    ...
    name: "Powell Library",
    num_rooms: 9,
    address: "10740 Dickson Ct, Los Angeles, CA",
  },
...
function extractStudyRooms(htmlContent: string): StudyRoom[] {
  ...
  for (const match of matches) {
    ...
    if (!url.startsWith("https://")) {
      url = "https://calendar.library.ucla.edu" + url;
    }
...
async function getReservation(
  ...
  const url = "https://calendar.library.ucla.edu/spaces/availability/grid";
  ...
  const headers = {
    ...
    referer: "https://calendar.library.ucla.edu/allspaces",
    "user-agent":
...
async function getFormattedLibraryData(
  ...
  try {
    ...
    const allSpacesUrl = "https://calendar.library.ucla.edu/allspaces";
    const allSpacesResponse = await axios.get(allSpacesUrl, {
      headers: USER_AGENT,
    });
    // console.log(allSpacesResponse.data, "fetched successfully");
...
function initializeLibraryFacilities(): Record<string, Facility> {
  return {
    ...
    "Powell Library": {
      ...
      coordinates: {
        latitude: 34.07160565885317,
        longitude: -118.4421709044893, // -118.4421709044893,
      },
      hours: { open: "", close: "" },
      rooms: {},
      isOpen: false,
    ...
    "Young Research Library": {
      ...
      type: FacilityType.LIBRARY,
      coordinates: {
        latitude: 34.07493392098452,
        longitude: -118.44148976538565, 
      },
      hours: { open: "", close: "" },
      rooms: {},
      isOpen: false,
    ...
    "Music Library": {
      ...
      type: FacilityType.LIBRARY,
      coordinates: {
        latitude: 34.070959487193676,
        longitude: -118.44039179583316, 
      },
      hours: { open: "", close: "" },
      rooms: {},
      isOpen: false,
    ...
    "Biomedical Library": {
      ...
      type: FacilityType.LIBRARY,
      coordinates: {
        latitude: 34.06674557454046,
        longitude: -118.44244022219476, 
      },
      hours: { open: "", close: "" },
      rooms: {},
      isOpen: false,
    ...
    "Science and Engineering Library": {
      ...
      type: FacilityType.LIBRARY,
      coordinates: {
        latitude: 34.06906108700814,
        longitude: -118.44260599157482, 
      },
      hours: { open: "", close: "" },
      rooms: {},
      isOpen: false,
