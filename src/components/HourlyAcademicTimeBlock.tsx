...
const HourlyAcademicTimeBlock = ({
  ...
  const startTime = moment.tz(`1970-01-01T${block.start}`, "America/Los_Angeles");
  const endTime = moment.tz(`1970-01-01T${block.end}`, "America/Los_Angeles");
...
const BlockSectionComponent = ({ section, parentBlock }: BlockSectionProps) => {
  const startTime = moment.tz(`1970-01-01T${section.start}`, "America/Los_Angeles");
  const endTime = moment.tz(`1970-01-01T${section.end}`, "America/Los_Angeles");
